...
public class JSONValueYtj {
    ...
    public String getBusinessId() throws JSONException {
        String bId;
        try {
           bId = yritys.getJSONArray("results").getJSONObject(0).get("businessId").toString(); 
        } catch (JSONException e) {
            return "N/A";
        }
        return bId;
    ...
    public String getName() throws JSONException {
        String name;
        try {
           name = yritys.getJSONArray("results").getJSONObject(0).getJSONArray("names").getJSONObject(0).get("name").toString(); 
        } catch (JSONException e) {
            return "N/A";
        }
        return name;
                    ...
                    if (regEnt.getJSONObject(i).get("register").toString().equals("4")) {
                        if (regEnt.getJSONObject(i).get("language").toString().equals("FI")) {
                            if (regEnt.getJSONObject(i).get("endDate").toString().equals("null")) {
                                return regEnt.getJSONObject(i).get("description").toString();
                            }
                        }
                    }
                }
                    ...
                    if (regEnt.getJSONObject(i).get("version").toString().equals("1")) {
                        if (regEnt.getJSONObject(i).get("language").toString().equals("FI")) {
                            if (regEnt.getJSONObject(i).get("source").toString().equals("2")) {
                                return regEnt.getJSONObject(i).get("name").toString();
                            }
                        }
                    }
                }
            ...
            for (int i = 0; i < regEnt.length(); i++) {
                if (regEnt.getJSONObject(i).get("order").toString().equals("0")) {
                    if (regEnt.getJSONObject(i).get("version").toString().equals("1")) {
                        if (regEnt.getJSONObject(i).get("language").toString().equals("FI")) {
                            if (regEnt.getJSONObject(i).get("source").toString().equals("2")) {
                                return regEnt.getJSONObject(i).get("code").toString();
                            }
                        }
                    }
                }
            ...
            for (int i = 0; i < regEnt.length(); i++) {
                if (regEnt.getJSONObject(i).get("language").toString().equals("FI")) {
                    if (regEnt.getJSONObject(i).get("type").toString().equals("Kotisivun www-osoite")) {
                        if (regEnt.getJSONObject(i).get("endDate").toString().equals("null")) {
                            return regEnt.getJSONObject(i).get("value").toString();
                        }
                    }
                }
            }
            ...
            for (int i = 0; i < regEnt.length(); i++) {
                if (regEnt.getJSONObject(i).get("version").toString().equals("1")) {
                    if (regEnt.getJSONObject(i).get("type").toString().equals("1")) {
                        if (regEnt.getJSONObject(i).get("endDate").toString().equals("null")) {
                            return regEnt.getJSONObject(i).get("postCode").toString();
                        }
                    }
                }
            }
        ...
        try {
            for (int i = 0; i < regEnt.length(); i++) {
                if (regEnt.getJSONObject(i).get("version").toString().equals("1")) {
                    if (regEnt.getJSONObject(i).get("type").toString().equals("1")) {
                        if (regEnt.getJSONObject(i).get("endDate").toString().equals("null")) {
                            return regEnt.getJSONObject(i).get("city").toString();
                        }
                    }
                }
            }
        ...
        try {
            for (int i = 0; i < regEnt.length(); i++) {
                if (regEnt.getJSONObject(i).get("version").toString().equals("1")) {
                    if (regEnt.getJSONObject(i).get("type").toString().equals("1")) {
                        if (regEnt.getJSONObject(i).get("endDate").toString().equals("null")) {
                            return regEnt.getJSONObject(i).get("street").toString();
                        }
                    }
                }
            }
    ...
    public String getCompanyForm() throws JSONException {
        try {
            ...
            for (int i = 0; i < regEnt.length(); i++) {
                if (regEnt.getJSONObject(i).get("endDate").toString().equals("null")) {
                    if (regEnt.getJSONObject(i).get("language").toString().equals("FI")) {
                        return regEnt.getJSONObject(i).get("name").toString() + " " + regEnt.getJSONObject(i).get("type").toString();
                    }
                }
            }
            return "";
